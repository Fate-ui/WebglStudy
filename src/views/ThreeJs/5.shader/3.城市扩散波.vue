...
<template>
  ...
  <div class="fixed left-20px top-20px px-20px leading-50px z-1 bg-white rounded">
    <span>学习来源：</span>
    <a href="https://www.bilibili.com/video/BV1is4y127J5/?spm_id_from=333.788&vd_source=c21dc7a2f93289c8e3df1bde97f015b9" target="_blank" class="text-blue">
      B站：three.js智慧城市扫光shader-扫光
    </a>
  </div>
</template>
