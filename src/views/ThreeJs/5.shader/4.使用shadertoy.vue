...
import { DoubleSide, Mesh, PerspectiveCamera, PlaneGeometry, Scene, ShaderMaterial, Vector2, WebGLRenderer } from 'three'
...
const z = size.height / 2 / Math.tan((fov * Math.PI) / 360)
...
`
/**
 * @see: https://www.shadertoy.com/view/wdfGW4
 * */
 ...
 * 地面
 * */
const plane = new Mesh(new PlaneGeometry(size.width, size.height), material)
scene.add(plane)
...
useEventListener('resize', () => {
  ...
  plane.geometry = new PlaneGeometry(size.width, size.height)
...
<template>
  ...
  <div class="fixed left-20px top-20px p-20px leading-25px z-1 bg-white rounded flex">
    <span>学习来源：</span>
    <div class="flex flex-col">
      <a href="https://www.bilibili.com/video/BV1Km4y127uP/?spm_id_from=333.788&vd_source=c21dc7a2f93289c8e3df1bde97f015b9" target="_blank" class="text-blue">
        B站：three.js使用shadertoy提供的shader
      </a>
      <a href="https://www.shadertoy.com/view/wdfGW4" target="_blank" class="text-blue">shadertoy：Descent 3D </a>
    </div>
  </div>
</template>
