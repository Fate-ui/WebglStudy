import{S as F,P as D,W as z,K as L,b2 as B,b as x,f as E,a as w,D as C,h as G,j as H,m as l}from"./three.module-QHcyoKWZ.js";import{O as A}from"./OrbitControls-8TWoeIgH.js";import{G as I}from"./GLTFLoader-ETY4XINV.js";import{D as O}from"./DRACOLoader-7188Xsnz.js";import{g as s}from"./index-nk37oyWQ.js";import{E as k,R as U,U as V}from"./UnrealBloomPass-eqaaeG4W.js";import{d as j}from"./index-W38Qjy34.js";import{d as J,s as K,l as q,p as N,o as Q,c as X}from"./index-EijTbRPw.js";const ae=J({__name:"8.自定义着色器",setup(Y){const t={width:window.innerWidth,height:window.innerHeight},i=new F,a=new D(45,t.width/t.height,.1,1e3);a.position.set(0,3,3);const n=new z({antialias:!0,logarithmicDepthBuffer:!0});n.setSize(t.width,t.height),n.setPixelRatio(window.devicePixelRatio);const c=K();q(()=>{c.value.appendChild(n.domElement)});const p=new A(a,n.domElement);p.autoRotate=!0;const d=new k(n),P=new U(i,a);d.addPass(P);const _=new V(new L(t.width,t.height),.6,.5,.5);d.addPass(_),n.setAnimationLoop(()=>{d.render(),p.update()});const r=document.createElement("video");r.src="textures/zp2.mp4",r.muted=!0,r.loop=!0;const f=new B(r),g=new x(new E(6.4,3.6),new w({map:f,side:C,transparent:!0,alphaMap:f}));g.rotation.x=-Math.PI/2,i.add(g);const m=new O;m.setDecoderPath("draco/"),m.preload();const h=new I;h.setDRACOLoader(m),h.load("model/building-min.glb",e=>{const o=e.scene;o.scale.set(.01,.01,.01),i.add(o),o.traverse(u=>{u instanceof x&&(u.material.dispose(),u.material=M())})});function M(){const e=new w({color:"#28B1CC",wireframe:!0,opacity:.5,transparent:!0,side:C});return e.onBeforeCompile=o=>{o.fragmentShader=o.fragmentShader.replace("#include <dithering_fragment>",`
