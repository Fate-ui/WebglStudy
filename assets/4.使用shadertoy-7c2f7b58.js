import{S as y,P as m,W as x,K as n,N as g,D as w,b as u,f as d}from"./three.module-4d045381.js";import{a as z,u as C}from"./index-5e038ddf.js";import{d as b}from"./index-1a26f821.js";import{d as k,l as D,s as _,p as P,o as S,c as B,h as t,F as T}from"./index-b6882ffc.js";const A=t("div",{class:"fixed left-20px top-20px p-20px leading-25px z-1 bg-white rounded flex"},[t("span",null,"学习来源："),t("div",{class:"flex flex-col"},[t("a",{href:"https://www.bilibili.com/video/BV1Km4y127uP/?spm_id_from=333.788&vd_source=c21dc7a2f93289c8e3df1bde97f015b9",target:"_blank",class:"text-blue"}," B站：three.js使用shadertoy提供的shader "),t("a",{href:"https://www.shadertoy.com/view/wdfGW4",target:"_blank",class:"text-blue"},"shadertoy：Descent 3D ")])],-1),s=45,H=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
`,I=k({__name:"4.使用shadertoy",setup(R){const e={width:window.innerWidth,height:window.innerHeight},a=new y,i=new m(s,e.width/e.height,.1,1e4),f=e.height/2/Math.tan(s*Math.PI/360);i.position.set(0,0,f);const o=new x({antialias:!0});o.setSize(e.width,e.height),o.setPixelRatio(window.devicePixelRatio),D(()=>{var c;(c=l.value)==null||c.appendChild(o.domElement)});const l=_(),{width:v,height:p}=o.getDrawingBufferSize(new n),h=new g({vertexShader:H,fragmentShader:W,transparent:!0,side:w,uniforms:{iResolution:{value:new n(v,p)},iTime:{value:0}}}),r=new u(new d(e.width,e.height),h);return a.add(r),z(()=>{o.render(a,i),h.uniforms.iTime.value+=.01}),P(()=>{b(a,o)}),C("resize",()=>{e.width=window.innerWidth,e.height=window.innerHeight,i.aspect=e.width/e.height;const c=e.height/2/Math.tan(s*Math.PI/360);i.position.set(0,0,c),i.updateProjectionMatrix(),r.geometry.dispose(),r.geometry=new d(e.width,e.height),o.setSize(e.width,e.height)}),(c,F)=>(S(),B(T,null,[t("div",{ref_key:"containerRef",ref:l},null,512),A],64))}});export{I as default};
