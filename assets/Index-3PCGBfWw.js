var d=Object.defineProperty;var u=(r,e,t)=>e in r?d(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var c=(r,e,t)=>(u(r,typeof e!="symbol"?e+"":e,t),t);import{r as h,E as p,S as f,P as v,W as g,h as w,j as x,m as P}from"./three.module-QHcyoKWZ.js";import{O as _}from"./OrbitControls-8TWoeIgH.js";import{a as S}from"./index-zO-Sle_b.js";import{F as T}from"./FBXLoader-LKKb6RG4.js";import{d as y}from"./index-W38Qjy34.js";import{d as A,s as C,l as L,p as E,o as b,c as D,h as n,F as N}from"./index-EijTbRPw.js";class R{constructor(){c(this,"updateData",()=>{if(!this.isStart)return!1;const e=this.clock.getDelta();this.time.value+=e,this.startTime.value+=e,this.startTime.value>=this.startLength.value&&(this.startTime.value=this.startLength.value)});this.fbxLoader=new T,this.group=new h,this.clock=new p,this.time={value:0},this.startTime={value:0},this.startLength={value:2},this.isStart=!1,this.fbxLoader.load("model/shanghai.FBX",e=>{this.group.add(e),e.traverse(t=>{t.name==="CITY_UNTRIANGULATED"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(a=>{a.transparent=!0,a.color.setStyle("#9370DB")}),t.name==="LANDMASS"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(a=>{a.transparent=!0,a.color.setStyle("#040912")})}),this.init()})}init(){this.isStart=!0,this.grow()}grow(){let e;this.group.traverse(i=>{i.name==="CITY_UNTRIANGULATED"&&(e=i)}),(Array.isArray(e.material)?e.material:[e.material]).forEach(i=>{i.onBeforeCompile=a=>{a.uniforms.uTime=this.time,a.uniforms.uPeriod={value:4};const o=`
          uniform float uTime;
