import{S as w,P as C,W as g,b as u,f as x,a as b,D as _,B as y,N as M,h}from"./three.module-4d045381.js";import{O as S}from"./OrbitControls-67f14f60.js";import{a as P}from"./index-9ea2bc7a.js";import{d as R}from"./index-1a26f821.js";import{d as B,l as E,s as G,p as k,o as H,c as L}from"./index-4e7c88af.js";const s=20,J=B({__name:"1.柱体渐变",setup(W){const r={width:window.innerWidth,height:window.innerHeight},a=new w,l=new C(45,r.width/r.height,.1,1e3);l.position.set(0,30,60);const t=new g({antialias:!0});t.setSize(r.width,r.height),t.setPixelRatio(window.devicePixelRatio),E(()=>{var o;(o=m.value)==null||o.appendChild(t.domElement)});const m=G(),f=new S(l,t.domElement),{random:n}=Math;function p(){const o=new y(1,Math.max(n()*15,4),1,10),e=`
  varying vec3 vColor;
