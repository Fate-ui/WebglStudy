var c=Object.defineProperty;var u=(r,e,t)=>e in r?c(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var l=(r,e,t)=>(u(r,typeof e!="symbol"?e+"":e,t),t);import{r as d,E as h,S as f,P as p,W as v,h as w,j as g,m as P}from"./three.module-2f5a30fe.js";import{O as x}from"./OrbitControls-27c6eec7.js";import{a as S}from"./index-f6386e96.js";import{F as T}from"./FBXLoader-1e225398.js";import{d as A}from"./index-1a26f821.js";import{d as C,s as _,l as y,p as L,o as E,c as D}from"./index-f07ac78f.js";class R{constructor(){l(this,"updateData",()=>{if(!this.isStart)return!1;const e=this.clock.getDelta();this.time.value+=e,this.startTime.value+=e,this.startTime.value>=this.startLength.value&&(this.startTime.value=this.startLength.value)});this.fbxLoader=new T,this.group=new d,this.clock=new h,this.time={value:0},this.startTime={value:0},this.startLength={value:2},this.isStart=!1,this.fbxLoader.load("model/shanghai.FBX",e=>{this.group.add(e),e.traverse(t=>{t.name==="CITY_UNTRIANGULATED"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(i=>{i.transparent=!0,i.color.setStyle("#9370DB")}),t.name==="LANDMASS"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(i=>{i.transparent=!0,i.color.setStyle("#040912")})}),this.init()})}init(){this.isStart=!0,this.grow()}grow(){let e;this.group.traverse(a=>{a.name==="CITY_UNTRIANGULATED"&&(e=a)}),(Array.isArray(e.material)?e.material:[e.material]).forEach(a=>{a.onBeforeCompile=i=>{i.uniforms.uTime=this.time,i.uniforms.uPeriod={value:4};const o=`
          uniform float uTime;
