var S=Object.defineProperty;var b=(o,e,t)=>e in o?S(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var v=(o,e,t)=>(b(o,typeof e!="symbol"?e+"":e,t),t);import{r as L,E as R,V as B,by as D,bz as T,N as k,D as A,h as x,b as P,M as E,S as z,P as F,W as G,j as N,m as W}from"./three.module-QHcyoKWZ.js";import{O as j}from"./OrbitControls-8TWoeIgH.js";import{a as f}from"./index-du8DvFNP.js";import{F as V}from"./FBXLoader-LKKb6RG4.js";import{d as I}from"./index-W38Qjy34.js";import{d as O,s as U,l as X,p as Y,o as H,c as J,h as c,F as $}from"./index-bx_dK3Ep.js";class q{constructor(){v(this,"updateData",()=>{if(!this.isStart)return!1;const e=this.clock.getDelta();this.time.value+=e,this.startTime.value+=e,this.startTime.value>=this.startLength.value&&(this.startTime.value=this.startLength.value)});this.fbxLoader=new V,this.group=new L,this.clock=new R,this.time={value:0},this.startTime={value:0},this.startLength={value:2},this.isStart=!1,this.fbxLoader.load("model/shanghai.FBX",e=>{this.group.add(e),e.traverse(t=>{t.name==="CITY_UNTRIANGULATED"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(a=>{a.transparent=!0,a.color.setStyle("#9370DB")}),t.name==="LANDMASS"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(a=>{a.transparent=!0,a.color.setStyle("#040912")})}),this.init()})}init(){this.isStart=!0,this.clock.start(),this.createWall()}createWall(){const e={position:{x:0,y:20,z:0},height:200,radius:120,maxRadius:450,color:"#efad35",opacity:.4,period:2},t=new B,r=t.clone().setY(t.y+e.height),a=new D(t,r),s=new T(a,20,e.radius,220,!1);s.computeBoundingBox();const u=s.boundingBox.max,n=s.boundingBox.min,l=new k({opacity:e.opacity,transparent:!0,side:A,depthTest:!1,uniforms:{uMax:{value:u},uMin:{value:n},uColor:{value:new x(e.color)}},vertexShader:`
