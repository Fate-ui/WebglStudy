var h=Object.defineProperty;var p=(i,e,t)=>e in i?h(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var c=(i,e,t)=>(p(i,typeof e!="symbol"?e+"":e,t),t);import{r as v,E as w,a8 as x,M as y,i as S,b as A,S as C,P as _,W as F,h as L,j as R,m as P}from"./three.module-2f5a30fe.js";import{O as T}from"./OrbitControls-27c6eec7.js";import{a as M}from"./index-f6386e96.js";import{F as D}from"./FBXLoader-1e225398.js";import{d as W}from"./index-1a26f821.js";import{d as b,s as k,l as E,p as z,o as G,c as B}from"./index-f07ac78f.js";class j{constructor(){c(this,"updateData",()=>{if(!this.isStart)return!1;const e=this.clock.getDelta();this.time.value+=e,this.startTime.value+=e,this.startTime.value>=this.startLength.value&&(this.startTime.value=this.startLength.value)});this.fbxLoader=new D,this.group=new v,this.clock=new w,this.time={value:0},this.startTime={value:0},this.startLength={value:2},this.isStart=!1,this.fbxLoader.load("model/shanghai.FBX",e=>{this.group.add(e),e.traverse(t=>{t.name==="CITY_UNTRIANGULATED"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(a=>{a.transparent=!0,a.color.setStyle("#9370DB")}),t.name==="LANDMASS"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(a=>{a.transparent=!0,a.color.setStyle("#040912")})}),this.init()})}init(){this.isStart=!0,this.clock.start(),this.createRadar()}createRadar(){const e={position:{x:0,y:20,z:0},radius:240,color:"#f005f0",opacity:.5,speed:300,followWidth:220},t=new x(e.radius,1e3),r=new y().makeRotationX(-Math.PI/180*90);t.applyMatrix4(r);const a=new S({color:e.color,opacity:e.opacity,transparent:!0}),n=new A(t,a);n.name="radar";const{x:s,y:l,z:g}=e.position;n.position.set(s,l,g),n.updateMatrix(),this.group.children[0].add(n),a.onBeforeCompile=o=>{Object.assign(o.uniforms,{uSpeed:{value:e.speed},uRadius:{value:e.radius},uTime:this.time,uFollowWidth:{value:e.followWidth}});const f=`
