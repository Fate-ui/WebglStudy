import{S as F,P as D,W as z,K as L,aS as B,b as x,f as E,a as w,D as C,h as G,j as H,m as l}from"./three.module-4dd0ab4d.js";import{O as A}from"./OrbitControls-79d41aec.js";import{G as I}from"./GLTFLoader-f2abeb44.js";import{D as O}from"./DRACOLoader-f3a7d95a.js";import{g as s}from"./index-4db78ffb.js";import{E as k,R as U,U as V}from"./UnrealBloomPass-9bc9c73f.js";import{d as j}from"./index-1a26f821.js";import{d as J,s as K,l as q,p as N,o as Q,c as X}from"./index-2c776554.js";const re=J({__name:"8.自定义着色器",setup(Y){const t={width:window.innerWidth,height:window.innerHeight},i=new F,r=new D(45,t.width/t.height,.1,1e3);r.position.set(0,3,3);const n=new z({antialias:!0,logarithmicDepthBuffer:!0});n.setSize(t.width,t.height),n.setPixelRatio(window.devicePixelRatio);const c=K();q(()=>{c.value.appendChild(n.domElement)});const p=new A(r,n.domElement);p.autoRotate=!0;const d=new k(n),P=new U(i,r);d.addPass(P);const _=new V(new L(t.width,t.height),.6,.5,.5);d.addPass(_),n.setAnimationLoop(()=>{d.render(),p.update()});const a=document.createElement("video");a.src="textures/zp2.mp4",a.muted=!0,a.loop=!0;const f=new B(a),g=new x(new E(6.4,3.6),new w({map:f,side:C,transparent:!0,alphaMap:f}));g.rotation.x=-Math.PI/2,i.add(g);const m=new O;m.setDecoderPath("draco/"),m.preload();const h=new I;h.setDRACOLoader(m),h.load("/model/building-min.glb",e=>{const o=e.scene;o.scale.set(.01,.01,.01),i.add(o),o.traverse(u=>{u instanceof x&&(u.material.dispose(),u.material=M())})});function M(){const e=new w({color:"#28B1CC",wireframe:!0,opacity:.5,transparent:!0,side:C});return e.onBeforeCompile=o=>{o.fragmentShader=o.fragmentShader.replace("#include <dithering_fragment>",`
    #include <dithering_fragment>
    //#end#
    `),console.log(o.vertexShader),W(o),R(o),b(o),y(o)},e}function W(e){e.uniforms.uTopColor={value:new G("#e9eaef")},e.uniforms.uHeight={value:1200},e.vertexShader=e.vertexShader.replace("#include <common>",`
      #include <common>
