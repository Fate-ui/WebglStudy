var C=Object.defineProperty;var S=(o,e,t)=>e in o?C(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var h=(o,e,t)=>(S(o,typeof e!="symbol"?e+"":e,t),t);import{r as L,E as R,V as b,bp as D,bq as T,$ as A,D as B,h as v,b as P,M as k,S as E,P as G,W as F,j as W,m as z}from"./three.module-cb7ba46f.js";import{O as I}from"./OrbitControls-7501b747.js";import{a as w}from"./index-6eec6ec5.js";import{F as N}from"./FBXLoader-655ad3f8.js";import{d as O}from"./index-1a26f821.js";import{d as U,s as V,l as j,p as X,o as Y,c as $}from"./index-762269ff.js";class q{constructor(){h(this,"updateData",()=>{if(!this.isStart)return!1;const e=this.clock.getDelta();this.time.value+=e,this.startTime.value+=e,this.startTime.value>=this.startLength.value&&(this.startTime.value=this.startLength.value)});this.fbxLoader=new N,this.group=new L,this.clock=new R,this.time={value:0},this.startTime={value:0},this.startLength={value:2},this.isStart=!1,this.fbxLoader.load("model/shanghai.FBX",e=>{this.group.add(e),e.traverse(t=>{t.name==="CITY_UNTRIANGULATED"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(a=>{a.transparent=!0,a.color.setStyle("#9370DB")}),t.name==="LANDMASS"&&(Array.isArray(t.material)?t.material:[t.material]).forEach(a=>{a.transparent=!0,a.color.setStyle("#040912")})}),this.init()})}init(){this.isStart=!0,this.clock.start(),this.createWall()}createWall(){const e={position:{x:0,y:20,z:0},height:200,radius:120,maxRadius:450,color:"#efad35",opacity:.4,period:2},t=new b,r=t.clone().setY(t.y+e.height),a=new D(t,r),s=new T(a,20,e.radius,220,!1);s.computeBoundingBox();const l=s.boundingBox.max,n=s.boundingBox.min,c=new A({opacity:e.opacity,transparent:!0,side:B,depthTest:!1,uniforms:{uMax:{value:l},uMin:{value:n},uColor:{value:new v(e.color)}},vertexShader:`
