import{S as D,P as b,W as T,T as S,K as _,f as M,$ as U,b as W}from"./three.module-2f5a30fe.js";import{u as C,a as I}from"./index-6e4d2cdc.js";import{G as R}from"./dat.gui.module-5ea4ba08.js";import{d as P}from"./index-1a26f821.js";import{d as V,s as j,l as F,p as G,o as L,c as k}from"./index-76c78296.js";const p="/WebglStudy/assets/car-cd57db70.png",m="/WebglStudy/assets/carDepth-6e9db6e1.jpg",E="/WebglStudy/assets/building-52af8ebf.png",z="/WebglStudy/assets/buildingDepth-2c0d70d1.jpg",B="/WebglStudy/assets/person-7fedc1b5.png",$="/WebglStudy/assets/personDepth-3c6ec6cc.jpg",A=V({__name:"2.深度图",setup(H){const e={width:window.innerWidth,height:window.innerHeight},r=new D,i=new b(45,e.width/e.height,1,1e4);i.position.set(0,0,24);const t=new T({antialias:!0});t.setSize(e.width,e.height),t.setPixelRatio(window.devicePixelRatio);const u=j();F(()=>{u.value.appendChild(t.domElement)});const s=new S,h=s.load(p),g=s.load(m),a=new _,v=new M(38.4,21.6),o=new U({uniforms:{uTexture:{value:h},uDepthTexture:{value:g},uMouse:{value:a}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
